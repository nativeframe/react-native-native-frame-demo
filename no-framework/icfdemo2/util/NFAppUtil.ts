import {
  CONSTRAINTS_AUDIO_OPTIMAL_STRICT, CONSTRAINTS_AUDIO_OPTIMAL_WEAK,
  CONSTRAINTS_SCREENCAPTURE_OPTIMAL_WEAK, CONSTRAINTS_VIDEO_OPTIMAL_STRICT, CONSTRAINTS_VIDEO_OPTIMAL_WEAK, types
} from "@video/video-client-core";
import { ExistsStreamPolicy } from "@video/video-client-core/lib/api";
import { NFSession } from "./NFSession";

export const endpoint_demo = 'https://dev2.devspace.lsea4.livelyvideo.tv';

export async function getAuthTokenForDemo(opts: NFSession): Promise<string> {
